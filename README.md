...
- $\texttt{docs/1758971705\_字符模式 SAC v3.0.1 评价论文.md}$
...
- $\texttt{docs/1758971929\_字符模式 SAC v3.0.1 总评价与评述.md}$
...
- $\texttt{docs/1758973000\_字符模式 SAC 的工程实现与数学化描述v4.0.0.md}$
...
- $\texttt{docs/1758974205\_字符模式 SAC v4.0.0 决策摘要与双迭代方案.md}$
