...
- `docs/1758988802_语义动力学框架（HACA｜A Framework for Semantic Dynamics）.md`
...
- `docs/1758988803_分层代数认知架构（HACA）公理系统与形式化定义.md`
...
- `docs/1758988804_分层代数认知架构（HACA）v1.0 公理化定义评价.md`
...
- `docs/1758988805_主纤维丛 × 逻辑压强场 × MDQ（HACA） 的工程—数学统一：从字符级RL到可审计的语义动力学.md`
...
- `docs/1758988806_Python环境与依赖版本说明.md`
...
- `docs/1758988807_AI远景价值评估：HACA（主纤维丛 × 逻辑压强场 × MDQ）的战略潜力与产业化路径.md`
