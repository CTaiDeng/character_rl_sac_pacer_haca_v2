...
- `docs/1759866578_从形式代数到内生哲学：$HACA_{LLM}$作为白盒AI决策框架的终极形态.md`
  - 摘要：TODO：请补充本篇文档摘要（120–300字）。
- `docs/1759871954_$HACA_{LLM}$的终极形态：一个完备的白盒AI认知操作系统及其战略价值评估.md`
  - 摘要：TODO：请补充本篇文档摘要（120–300字）。
- `docs/1759872156_从形式代数到内生哲学：HACA-LLM作为解决OpenRA稀疏奖励问题的终极白盒方案.md`
  - 摘要：TODO：请补充本篇文档摘要（120–300字）。
